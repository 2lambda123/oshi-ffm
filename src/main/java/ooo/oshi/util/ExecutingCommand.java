...
import ooo.oshi.PlatformEnum;
import ooo.oshi.SystemInfo;
...
public final class ExecutingCommand {
    ...
    private static final boolean IS_WINDOWS = PlatformEnum.WINDOWS.equals(SystemInfo.getCurrentPlatform());
